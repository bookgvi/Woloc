  ...
  .specifications
    ...
    .row.q-pb-lg(:key="reloadFields")
      .col.q-pr-sm
        ...
        span.text-red *
        q-input(v-model="specification.height" :rules="[val => !!val || 'Обязательно для заполнения']" autofocus outlined dense)
      .col
        span(style="line-height: 0;") Площадь, м
          sup 2
        span &nbsp;
        span.text-red *
        q-input(v-model="specification.yardage" :rules="[val => !!val || 'Обязательно для заполнения']" autofocus outlined dense)
